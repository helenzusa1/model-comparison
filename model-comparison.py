...
# This is to check if the model deployment support 'reasoning effort' parameter. 
# For my current setup, only gpt-5 does.
...
def measure_metrics(model_name: str, reasoning=None):
    ...
    if reasoning and supports_reasoning_param(model_name):
